const requestErrors = {
    ...
    InvalidTxReceiverAddress : {code : -11009, message : "invalid tx receiver address, address should have 40 characters, please include 0x as the prefix"},
    InvalidDerivedKeyType : {code : -11010, message : "Wrong key type for deriving new key, valid key type should be either OLT, BTC-P2PK, BTC-P2PKH or ETH"},
    InvalidSignKeyType : {code : -11010, message : "Wrong key type for signing tx, valid key type should be either OLT, BTC or ETH"}
};
