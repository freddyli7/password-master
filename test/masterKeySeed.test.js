...
const invalidMnemonicArray = [{index: 1, word: 'turtle'},
    {index: 2, word: 'issue'},
    {index: 3, word: 'gloom'},
    {index: 4, word: 'race'},
    {index: 5, word: 'blast'},
    ...
    {index: 22, word: 'hope'},
    {index: 23, word: 'have'},
    {index: 24, word: 'freddy'}];

describe("test mnemonic array verify", function () {
    it("test 1, valid mnemonic", function () {
        const mnemonicStr = masterKeySeed.verifyMnemonic(mnemonicArray);
        console.log(mnemonicStr);
        should.equal(mnemonicStr, true)
    });
    it("test 2, invalid mnemonic", function () {
        const mnemonicStr = masterKeySeed.verifyMnemonic(invalidMnemonicArray);
        console.log(mnemonicStr);
        should.equal(mnemonicStr, false)
    })
});
